...
def build_html(page, api_key) -> tuple[str, str]:
    ...
    note_section = (
        ...
        f"<p style='margin:0;color:#222;line-height:1.7;font-size:14px'>{html_lib.escape(sections['note_text'])}</p>"
        f"</td></tr>"
...
<body style="margin:0;padding:24px;background:#f5f5f5;font-family:Arial,sans-serif;">
  ...
  <table style="max-width:900px;width:100%;border-collapse:collapse;border:2px solid #d0d0d0;background:#ffffff;" cellpadding="0" cellspacing="0">
    <!-- 헤더 -->
    <tr>
        ...
        <table style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
          <tr>
            <td style="vertical-align:bottom;">
              <p style="margin:0;font-size:24px;font-weight:700;color:#ffffff;">주간업무보고</p>
            ...
            <td style="text-align:right;vertical-align:bottom;white-space:nowrap;">
              <p style="margin:0;font-size:22px;font-weight:700;color:#ffffff;">{html_lib.escape(week)}</p>
    ...
    <tr><td style="padding:0 28px 20px;">
      ...
      <p style="margin:0;color:#222;line-height:1.7;font-size:14px;">{html_lib.escape(sections['issue_text'])}</p>
    </td></tr>
    {note_section}
  </table>
</body>
